...
/**
 * Teste com alguns eventos com consumos nulos para a aplicação
 * 
 * @author Cesar Buzin
 */
public class SimpleTest9 {
	...
	public void setup() {
		...
		sensorEvents.add(new SensorEvent(createTimestamp(1, 15), Arrays.asList(null, 3, 30, 2, 30)));
		...
		sensorEvents.add(new SensorEvent(createTimestamp(4, 30), Arrays.asList(null, 29, 230, 2, 208)));
		...
		sensorEvents.add(new SensorEvent(createTimestamp(9, 15), Arrays.asList(null, 83, 274, 3, -759, 45)));
		
		sensorEvents.add(new SensorEvent(createTimestamp(13, 15), Arrays.asList(null, 83, 274, 3, -759, 45)));
	}

	@Test
	public void testApplianceBreakdownSingleAppliance() throws Exception {
		Appliance appliance = new Appliance(1, "key 1", 100);
